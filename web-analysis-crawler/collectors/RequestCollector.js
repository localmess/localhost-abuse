...
const DEFAULT_SAVE_HEADERS = ['origin', 'referer', 'etag', 'set-cookie', 'cache-control', 'expires', 'pragma', 'p3p', 'timing-allow-origin', 'access-control-allow-origin', 'accept-ch'];
...
class RequestCollector extends BaseCollector {
    ...
    handleRequest(data, cdp) {
         ...
         * @type {InternalRequestData}
         */
        const requestData = {id, url, method, type, initiator, startTime, wallTime};
    ...
    getData({urlFilter}) {
        ...
        return this._requests
            ...
            .map(request => ({
                ...
                requestHeaders: request.requestHeaders && filterHeaders(request.requestHeaders, this._saveHeaders),
